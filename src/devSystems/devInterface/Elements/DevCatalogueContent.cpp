...
void DevCatalogueSelector::buildElement(BuildContext& context) {
	drawStub(context, "Catalogue selector stub");
}

void DevCatalogueWorkbench::buildElement(BuildContext& context) {
	drawStub(context, "Catalogue workbench stub");
}

void DevCatalogueInspector::buildElement(BuildContext& context) {
	drawStub(context, "Catalogue inspector stub");
}
