...
struct DevInterfaceHeaderResources {
	TextureRef undoIcon{};
	TextureRef redoIcon{};

	DevInterfaceHeaderResources() = default;
	explicit DevInterfaceHeaderResources(App& app);
};
...
struct DevInterfaceHeader {
	...
	using Resources = DevInterfaceHeaderResources;
